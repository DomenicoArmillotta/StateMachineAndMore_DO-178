...
/* State_machine_iterator::SM_itera/SM1: */
typedef enum kcg_tag_SSM_TR_SM1 {
  SSM_TR_no_trans_SM1,
  SSM_TR_init_State2_1_init_SM1,
  SSM_TR_State2_Error_1_State2_SM1
} SSM_TR_SM1;
/* State_machine_iterator::SM_itera/SM1: */
...
/* State_machine_iterator::SM_itera/SM1:State2:SM3: */
typedef enum kcg_tag_SSM_TR_SM3_State2_SM1 {
  SSM_TR_no_trans_SM3_State2_SM1,
  SSM_TR_State4_State5_1_State4_SM3_State2_SM1
} SSM_TR_SM3_State2_SM1;
/* State_machine_iterator::SM_itera/SM1:State2:SM3: */
typedef enum kcg_tag_SSM_ST_SM3_State2_SM1 {
  SSM_st_State4_SM3_State2_SM1,
  SSM_st_State5_SM3_State2_SM1
} SSM_ST_SM3_State2_SM1;
/* State_machine_iterator::SM_itera/SM1:State2:SM2: */
typedef enum kcg_tag_SSM_TR_SM2_State2_SM1 {
  SSM_TR_no_trans_SM2_State2_SM1,
  SSM_TR_StateContninuous_StateContninuous_1_StateContninuous_SM2_State2_SM1
} SSM_TR_SM2_State2_SM1;
/* State_machine_iterator::SM_itera/SM1:State2:SM2: */
typedef enum kcg_tag_SSM_ST_SM2_State2_SM1 {
  SSM_st_StateContninuous_SM2_State2_SM1
